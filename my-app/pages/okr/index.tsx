...
import ModalOKr from "@/components/modal/modalOkr";
...
export default function Okr() {
  ...
  //get data okr
  const getDataOkr = useQuery(
    ["dataOKR"], () => handleGetData(),
  )
  const dtProgress = [
    {
      label: "nameA",
            ...
            <div className="border-b-2">
              ...
              >
                ...
                <Stack direction="row" spacing={2}>
                  <Button onClick={() => {setShowModal(true)}} variant="outlined" startIcon={<Add />}>
                    Add
                  </Button>
                  <Button
                    variant="outlined"
    ...
    {showModal &&
            <Modal title="Tạo mới OKR" onClose={() => setShowModal(false)}>
              <Stack paddingTop={2}>
                ...
                <Stack paddingTop={10} justifyContent={"space-between"} direction={"row"}>
                  <Stack>
                  <InputLabel>Ngày băt đầu</InputLabel>
                  <div className="p-5 border-2"><input type="datetime-local" placeholder="Ngày bắt đầu"/></div>
                  </Stack>
                  <Stack>
                  <InputLabel>Ngày băt đầu</InputLabel>
                  <div className="p-5 border-2"><input type="datetime-local" placeholder="Ngày kết thúc"/></div>
                  </Stack>
                </Stack>            
              </Stack>
              <Stack width={"20%"} paddingTop={3} direction={"row"} justifyContent={"space-between"}>
                <Button sx={{border:"1px solid"}}>Add</Button>
                <Button color="warning" sx={{border:"1px solid"}} onClick={() => setShowModal(false)}>Hủy</Button>
              </Stack>
            </Modal>
        }
    </>);
